...
Если мы поищем по **what is it**, то получим $[0, 1] \cap [0, 1, 2] \cap [0, 1, 2] = [0, 1]$ ($\cap$ — пересечение множеств, больше математических символов здесь). Т.е. найдутся тексты 1 и 2.
