...
> Слишком общая и очевидная вещь, кажется, не стоит выделять абстракцию как отдельный принцип ООП.
...
В первую очередь, это про инкапсуляцию. Нужно "говорить" объектам, что ты хочешь сделать, а не "спрашивать" состояние объекта и на основе этих данных принимать решение о действии над этим объектом. Объект в состоянии самостоятельно принять решение - его состояние принадлежит ему. 
