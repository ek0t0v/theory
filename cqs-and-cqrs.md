...
CQS и CQRS - по сути одно и то же. Главный принцип - разделение на команды и запросы. Команды изменяют состояние объекта, не возвращая значение. Запросы возвращают результат, не изменяя состояние объекта (у них нет побочных эффектов).
